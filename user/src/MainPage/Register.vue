    ...
    <div class="register-sheet">
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="auto" class="demo-ruleForm">
        <el-form-item label="设置ID" prop="userID" style="padding: auto;" >
          <el-input type="text" maxlength="10"  show-word-limit placeholder="请设置账户ID, 一旦设置则不可修改！" v-model="ruleForm.userID" autocomplete="off" style="margin:0;"></el-input>
        </el-form-item>
        <el-form-item label="设置昵称" prop="userName" style="padding: auto;">
          <el-input type="text" maxlength="10"   show-word-limit placeholder="请设置账户昵称" v-model="ruleForm.userName" autocomplete="off" style="margin:0;"></el-input>
        </el-form-item>
